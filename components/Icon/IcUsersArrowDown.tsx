...
export const IcUsersArrowDown: React.FC<{ size: string }> = ({ size }) => {
  return (
    <svg
      width={size.toString()}
    ...
    >
      ...
      />
      <path
        d="M24.1667 28.7998L27.2667 31.8998C27.2964 31.9321 27.3325 31.958 27.3726 31.9756C27.4128 31.9933 27.4562 32.0024 27.5001 32.0024C27.544 32.0024 27.5874 31.9933 27.6275 31.9756C27.6677 31.958 27.7037 31.9321 27.7334 31.8998L30.8334 28.7998"
        stroke="#151515"
        strokeWidth="2.5"
        strokeLinecap="round"
        strokeLinejoin="round"
