...
export const IcStatisticsCircleChart: React.FC<{ size: string }> = ({
  size,
}) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M25 15.0001H35.9C35.095 12.4399 33.6836 10.1119 31.7859 8.21421C29.8882 6.31649 27.5602 4.90511 25 4.1001V15.0001Z"
        stroke="#151515"
        strokeWidth="2.5"
        strokeLinecap="round"
        strokeLinejoin="round"
